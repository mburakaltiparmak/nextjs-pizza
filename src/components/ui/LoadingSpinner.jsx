...
export function LoadingSpinner({ text = "Yükleniyor", size = "medium", className = "" }) {
    // Size classes
    const sizeClasses = {
        small: {
            container: "py-2",
    ...
    return (
        <div className={`flex flex-col items-center justify-center w-full ${container} ${className}`}>
