...
const Footer = () => {
  return (
    <div className="flex flex-col items-center justify-between gap-8 bg-darkgray text-lightgray py-4">
      <div className="flex flex-row justify-between items-start text-left px-8">
        ...
        <div className="flex flex-col justify-between items-center gap-8 text-lg font-bold font-Barlow p-4">
          <p>Instagram</p>
          <span className="flex flex-row flex-wrap justify-end items-center w-1/2 gap-1 ">
      ...
      <div className="flex flex-row justify-between gap-2 text-lightgray">
        <p className="flex flex-row items-center gap-1 text-xs">
          <FontAwesomeIcon
            className="object-cover w-[12px] h-fit"
            icon={faCopyright}
          />
