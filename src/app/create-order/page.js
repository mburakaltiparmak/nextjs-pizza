...
const Page = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="flex flex-col font-Barlow justify-center items-center py-8 min-h-[70vh]">
        <div className="flex flex-col gap-4 items-center border border-transparent px-10 py-8 rounded-lg z-50 bg-gradient-to-br from-red to-darkred shadow-lg max-w-md w-full mx-4">
          <div className="w-full text-center mb-2">
            <h1 className="text-3xl font-bold text-white mb-2">Sipariş Oluştur</h1>
            <p className="text-white text-opacity-90 text-sm mb-2">Siparişinizi tamamlamak için lütfen giriş yapın</p>
            <Separator orientation="horizontal" className="bg-white bg-opacity-20" />
          </div>
          ...
          <form className="mt-4 space-y-4 font-Barlow w-full" onSubmit={handleLogin}>
            ...
            <div className="flex flex-col space-y-3 pt-2">
              ...
              <div className="relative flex items-center justify-center my-1">
                ...
                <div className="px-3 text-xs text-white text-opacity-70">veya</div>
                <div className="border-t border-white border-opacity-20 w-full"></div>
              </div>
