  ...
  const statusCards = {
    loading: (
      <div className="flex flex-col items-center justify-center p-8 bg-white rounded-xl shadow-lg border border-gray-100">
        ...
        <h2 className="text-2xl font-Barlow font-bold text-gray-800 mb-3">Bağlanıyor</h2>
    ...
    success: (
      <div className="flex flex-col items-center justify-center p-8 bg-white rounded-xl shadow-lg border-l-4 border-green-500">
        ...
        <h2 className="text-3xl font-Barlow font-bold text-gray-800 mb-2">Giriş Başarılı!</h2>
    ...
    error: (
      <div className="flex flex-col items-center justify-center p-8 bg-white rounded-xl shadow-lg border-l-4 border-red">
        <div className="w-16 h-16 bg-red-50 rounded-full flex items-center justify-center mb-6 shadow-inner">
          <svg className="w-8 h-8 text-red" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12"></path>
          </svg>
        </div>
        <h2 className="text-3xl font-Barlow font-bold text-gray-800 mb-2">Giriş Başarısız</h2>
        <p className="text-gray-600 font-Quattrocento_Sans text-center mb-6">
          {message}
        </p>
        <button
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 p-4">
      <div className="w-full max-w-md mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-Londrina_Solid text-red">Teknolojik Yemekler</h1>
          <p className="text-gray-600 font-Quattrocento_Sans">Google ile Giriş</p>
        </div>
