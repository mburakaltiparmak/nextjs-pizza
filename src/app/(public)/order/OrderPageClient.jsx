...
import { useAppDispatch, useAppSelector } from "@/lib/store/hooks"; // Updated path
import { useToast } from "@/lib/hooks/useToast"; // This might need migration too
...
const OrderPageClient = () => {
    ...
    // const token = useSelector((state) => state.user.token); // Unused
    ...
    const [count /*, setLocalCount*/] = useState(1); // setLocalCount unused
    ...
    useEffect(() => {
        ...
        if (watchedBoyut === "S") {
            setBoyutFiyat(200);
        } else if (watchedBoyut === "M") {
            setBoyutFiyat(250);
        } else if (watchedBoyut === "L") {
            setBoyutFiyat(300);
        } else {
            setBoyutFiyat(0);
        }
        ...
        if (watchedHamur === "Ince") {
            setHamurFiyat(20);
        } else if (watchedHamur === "Standart") {
            setHamurFiyat(30);
        } else if (watchedHamur === "Kalin") {
            setHamurFiyat(40);
        } else {
            setHamurFiyat(0);
        }
