...
export const initializeAuth = () => async (dispatch) => {
  try {
    // 1. Önce localStorage veya sessionStorage'daki token'ı kontrol et
    ...
    if (token) {
      ...
      console.log("💾 Auth bilgileri başlatıldı, token:", token.substring(0, 10) + "...");
      return true;
    }
